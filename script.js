   ...
   for(i = 0; i < artistPlaylist.length; i++) {
     ...
     currentPlaylists[artistPlaylist[i].name] = [];
      var playlist= document.createElement('input')
       ...
       getVideoList(artistPlaylist[i].name, playlistLabel, '<img src="' + artistPlaylist[i].srcUrl + '" style="width:48px;height:32px;position:relative;top:10px" border="2.5"></img>' + artistPlaylist[i].id.slice(artistPlaylist[i].id.indexOf("-") + 1), '')
   }
